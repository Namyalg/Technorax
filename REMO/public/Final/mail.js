...
function sendtointerviewee() {
    Email.send({
        ...
        Body: "Hey " + $("#P2name").val() + "<br>" + "Your interview has been scheduled on " + $("#date-time").val().split("T")[0] + " at " + $("#date-time").val().split("T")[1] + "<br>." + "Visit the URL : https://removirtual-fa3b3.web.app/pre-interview/index.html . Join the room with the key - " + rand + "E" + "<br>. Wish you the best.",
    })
}
